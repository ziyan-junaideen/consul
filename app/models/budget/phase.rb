class Budget
  class Phase < ApplicationRecord
    PHASE_KINDS = %w[drafting informing ideas_posting project_forming accepting reviewing selecting
                     valuating publishing_prices balloting reviewing_ballots finished].freeze
