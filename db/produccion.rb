...
Setting.create(key: 'url', value: 'https://decide.puertoreal.es')
...
Setting.create(key: 'mailer_from_address', value: 'decide@puertoreal.es')
Setting.create(key: 'meta_description', value: 'Participación Ciudadana')
...
print "Creando el administrador..."
...
admin.update(residence_verified_at: Time.current, document_type: "1", verified_at: Time.current, document_number: "1111111111")
